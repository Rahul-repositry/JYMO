  ...
  ({ juid, handleJUIDinput, markAttendanceByJUID }, ref) => {
    return (
      <div className="reader-container pt-10">
        ...
        <div className=" inputCont w-72 mx-auto">
          <div className="relative w-full min-w-[200px]">
            <div className="absolute top-[12px] left-3 grid  text-blue-gray-500">
            ...
            <div
              className="absolute top-[12px] right-3 grid  text-blue-gray-500"
              onClick={markAttendanceByJUID}
            >
              <img src={snd} alt="snd img" className=" w-[30px]" />
            </div>
            <input
              className=" h-full w-full rounded-full border border-blue-gray-300 bg-transparent py-4 text-lg !pr-12 !pl-12 font-sans  font-normal text-blue-gray-700 outline outline-0 "
