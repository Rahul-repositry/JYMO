  ...
  return (
    <div className="max-w-[1600px] flex flex-col">
      ...
      <div className="detail">
        <div className="details smaller flex sm:hidden text-2xl flex-col text-start px-3 gap-9 py-8 mx-8 rounded-2xl">
        ...
        <div className="details hidden bg-white shadow-lg border sm:grid sm:grid-cols-2   lg:grid-cols-3 text-2xl   px-4  py-8 mx-8 rounded-2xl   ">
